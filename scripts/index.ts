...
function filtraCategoria (arrayDeBlusas:Blusa[] = blusas) {
  ...
  if(checkboxCategoriaChecked) {
    const inputFiltroCategoriaValue = (inputFiltroCategoria as HTMLInputElement).value;
...
function filtraCor (arrayDeBlusas:Blusa[] = blusas) {
  ...
  if(checkboxCorChecked) {
    const inputFiltroCor1Value = (inputFiltroCor1 as HTMLInputElement).value;
    ...
    const inputFiltroCor2Value = (inputFiltroCor2 as HTMLInputElement).value;
